    ...
    <div className="w-full min-h-[100vh] bg-[#fff8d7] text-[#910046] pt-[70px] pb-[110px] relative flex">
      ...
      <div className="absolute top-[80px] left-4 z-30">
        <button
          ...
          className="flex items-center justify-center w-12 h-12 rounded-md bg-[#910046] text-[#fff8d7] hover:bg-[#b30060] transition"
        >
        ...
        <div className="fixed inset-0 z-50 flex bg-black bg-opacity-50">
          <div className="w-[80vw] md:w-[320px] bg-[#fff8d7] text-[#910046] p-6 overflow-y-auto relative flex flex-col rounded-r-lg shadow-lg">
            <button
              ...
              className="absolute top-4 right-4 text-[#910046] hover:text-[#b30060]"
            >
            ...
            <button
              ...
              className="mt-4 bg-[#910046] text-[#fff8d7] font-semibold py-2 rounded-lg hover:bg-[#b30060] transition"
            >
              Apply
            </button>
          </div>
      ...
      <div className="flex-1 px-4 md:px-8 lg:px-16">
        <div className="flex flex-col lg:flex-row justify-center items-center mb-8 mt-[70px] text-center">
          <Title text1="WOMENS" text2="SECTION" />
        </div>

        <div className="flex justify-center mb-6">
          <select
            className="bg-[#910046] text-[#fff8d7] px-4 py-2 rounded-lg border-2 border-transparent hover:border-[#b30060] transition"
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {filterProduct.length > 0 ? (
            ...
            <p className="text-lg mt-10">No products found</p>
          )}
        </div>
      </div>
    </div>
